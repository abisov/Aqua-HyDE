...
### Variables ###
def_lang, def_temp, def_time, def_wind = (
    get_default_locale()
)  # default vals based on locale
load_env_file(
    os.path.join(os.environ.get("HOME"), ".local", "state", "hyde", "staterc")
)
...
headers = {"User-Agent": "Mozilla/5.0", "Accept-Language": weather_lang}
